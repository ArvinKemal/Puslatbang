        ...
        <div class="card w-100" style="max-width: 1500px; background-color: rgba(255, 255, 255, 0.85);">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2 logo-usk-himatekom">
                        <img src="img/picture1.png" alt="USK Logo" class="img-fluid">
                        <img src="img/HIMATEKKOM 2.png" alt="Himatekom Logo" class="img-fluid">
                    </div>
                </div>
